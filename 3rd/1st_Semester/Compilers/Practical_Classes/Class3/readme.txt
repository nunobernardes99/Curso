===============================================================
A scanner in Haskell.
===============================================================

1. Given the following Tokens:
...
such that lexer divides the input string in Tokens and lexNum recognises integers, produces a new token TokenInt Int, and calls the lexer for the rest of the string.

You may use the predefined functions isDigit, isSpace, read and span. Note that lexer calls lexNum (when the first character of its argument is a digit) and lexNum calls lexer (to scan the substring after having recognised an integer)
